 ...
 */
public class NetHeartbeatPing extends NetMsg<Ping> {

    public NetHeartbeatPing(NatedAddress src, NatedAddress dst) {
    ...
    public NetMsg copyMessage(Header<NatedAddress> newHeader) {
        return new NetHeartbeatPing(newHeader, getContent());
    }
